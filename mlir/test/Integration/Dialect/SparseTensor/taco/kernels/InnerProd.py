# RUN: python3 codegen.py --kernel InnerProd --inps 128 128 128 --par-strategy='none'
# Can substitute dimensions
#
# **WARNING** : --par-strategy='none' is required on this test.
#
...
def InnerProd(dim0: int, dim1: int, dim2) -> List[Tuple['Tensor', str]]:
    # Set up matrices
    A = pt.tensor([dim0, dim1, dim2], pt.dcc)
    B = pt.tensor([dim0, dim1, dim2], pt.dcc)
