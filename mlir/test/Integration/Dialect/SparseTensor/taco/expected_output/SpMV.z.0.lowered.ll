...
define { { ptr, ptr, i64, [1 x i64], [1 x i64] }, { [1 x i64], [1 x i64] } } @SpMV.z.0.main(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, ptr %5, ptr %6, i64 %7, i64 %8, i64 %9, ptr %10, ptr %11, i64 %12, i64 %13, i64 %14, { [2 x i64], [3 x i64] } %15, ptr %16, ptr %17, i64 %18, i64 %19, i64 %20, { [1 x i64], [1 x i64] } %21) {
...
omp_parallel:                                     ; preds = %55
  ...
  call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @1, i32 1, ptr @SpMV.z.0.main..omp_par.1, ptr %structArg49)
...
define internal void @SpMV.z.0.main..omp_par.1(ptr noalias %tid.addr, ptr noalias %zero.addr, ptr %0) #0 {
omp.par.entry:
...
omp_parallel:                                     ; preds = %omp.wsloop.region
  ...
  call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @1, i32 1, ptr @SpMV.z.0.main..omp_par, ptr %structArg)
...
; Function Attrs: norecurse nounwind
define internal void @SpMV.z.0.main..omp_par(ptr noalias %tid.addr4, ptr noalias %zero.addr5, ptr %0) #0 {
omp.par.entry6:
...
define void @_mlir_ciface_SpMV.z.0.main(ptr %0, ptr %1, ptr %2, ptr %3, { [2 x i64], [3 x i64] } %4, ptr %5, { [1 x i64], [1 x i64] } %6) {
  ...
  %32 = call { { ptr, ptr, i64, [1 x i64], [1 x i64] }, { [1 x i64], [1 x i64] } } @SpMV.z.0.main(ptr %9, ptr %10, i64 %11, i64 %12, i64 %13, ptr %15, ptr %16, i64 %17, i64 %18, i64 %19, ptr %21, ptr %22, i64 %23, i64 %24, i64 %25, { [2 x i64], [3 x i64] } %4, ptr %27, ptr %28, i64 %29, i64 %30, i64 %31, { [1 x i64], [1 x i64] } %6)
