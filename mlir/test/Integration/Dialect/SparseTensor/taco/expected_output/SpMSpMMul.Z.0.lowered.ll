...
omp_parallel:                                     ; preds = %75
  ...
  call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @1, i32 1, ptr @SpMSpMMul.Z.0.main..omp_par, ptr %structArg)
...
define internal void @SpMSpMMul.Z.0.main..omp_par(ptr noalias %tid.addr, ptr noalias %zero.addr, ptr %0) #0 {
omp.par.entry:
